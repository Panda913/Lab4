...
public class deleteStudentServlet extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try{
        String RecordBook =request.getParameter("Student");
        int RecordBookInt = Integer.parseInt(RecordBook);
        
        String NameFaculty =(String) request.getParameter("facultyName");
        ...
        for (Student  f :faculty.getStudents() ){
        if (f.getNumberRecordBook()==(RecordBookInt)){
         faculty.removeStudent(f);
